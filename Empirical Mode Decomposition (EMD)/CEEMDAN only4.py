...
TEST1_struct = FULLDATA_contents['ERPTEST2']    #Raw EEG+TACS DATA
...
final_modes = CEEMDAN_VER1(s,50,100,0.02, 6)

#cProfile.run('CEEMDAN_VER1(s,50,100,0.02, 5)')

sio.savemat('CEEMDAN_ONLY4_TEST2_ENTIRE.mat', {'CEEMDAN_ONLY4_TEST2_ENTIRE': final_modes})
