...
FULLDATA_contents = sio.loadmat('Test_1mA_5Hz_ERP_PH.mat')
...
final_modes = CEEMDAN_VER1(s, 50, 300, 0.02)
#cProfile.run('CEEMDAN_VER1(s,50,100,0.02)')

sio.savemat('PYTHON_ERP_1MA_10HZ.mat', {'PYTHON_ERP_1MA_10HZ': final_modes})
