...
for i in range(NR):
    for g in range(len(modes_white_noise[i][0])):
        #bug_modes_white_noise[0,g] = modes_white_noise[i][0][g]
        modes_white_noise_NSTD[i][0][g] = modes_white_noise[i][0][g]*Nstd  #multiply all values of first IMF by Nstd
        #bug_modes_white_noise_2[0,g] = modes_white_noise_NSTD[i][0][g]
