...
sham_tacs_t1 = 14990;   %%CHANGE sham boundary
sham_tacs_t2 = sham_tacs_t1 + 29999;
ERP_Sham_SMA=filtfilt(b,a,filtfilt(d,c,EEG.Data(1, sham_tacs_t1:sham_tacs_t2)));

load('Test_1mA_5Hz_ERP_PH.mat') %%CHANGE data !!!!!!!!!!
tacs_t1 = 15032;        %%CHANGE data boundary !!!!!!!!!!
tacs_t2 = tacs_t1 + 29999; 

RAW_DATA = EEG.Data(1,tacs_t1:tacs_t2);

load('PYTHON_ERP_1MA_5HZ.mat') %%CHANGE CEEMDAN RESULTS

modes = PYTHON_ERP_1MA_5HZ;
...
FREE_DATA = RAW_DATA - modes_original(1,:) + modes(4,:);
