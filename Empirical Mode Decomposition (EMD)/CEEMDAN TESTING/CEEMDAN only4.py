...
SUBJECT1_struct = FULLDATA_contents['SUBJECT2_10HZ_RESULTS']    #Raw EEG+TACS DATA

# CONVERT TO NPARRAY VARIABLES
SUBJECT1 = SUBJECT1_struct[0, 0]

s = SUBJECT1['DATA2_10HZ']

s = s[0, :]

final_modes = CEEMDAN_VER1(s,50,200,0.02, 5)

#cProfile.run('CEEMDAN_VER1(s,50,500,0.02, 5)')

sio.savemat('CEEMDAN_ONLY4_SUBJ2_10HZ_200.mat', {'CEEMDAN_ONLY4_SUBJ2_10HZ_200': final_modes})
