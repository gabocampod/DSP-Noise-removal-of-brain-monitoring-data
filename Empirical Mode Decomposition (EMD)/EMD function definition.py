...
FULLDATA_contents = sio.loadmat('points.mat')


# ALOCATE CORRECT STRUCTURES WITHIN DATA
modes_struct = FULLDATA_contents['points']    #Raw EEG+TACS DATA

# CONVERT TO NPARRAY VARIABLES
modes = modes_struct[0, 0]

s = modes['mode6']      #example data used is called mode 6.

s = s[0, :]     # s defines input data
