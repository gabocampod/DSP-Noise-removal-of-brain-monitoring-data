...
FULLDATA_contents = sio.loadmat('matlab_to_python_data_filtered_test1.mat')
...
final_modes = CEEMDAN_VER1(s, 50, 100, 0.02)

sio.savemat('CEEMDAN_NEW_APPROACH_TEST1.mat', {'CEEMDAN_NEW_APPROACH_TEST1': final_modes})
