...
load('Test_1mA_40Hz_ERP_SUBJ2.mat') 

RAW_SUBJECT_DATA = EEG.Data(1,:);

subject2_tacs_t1 = 15029;
...
SHAM_ORIGINAL_BEST=filtfilt(b,a,filtfilt(d,c,EEG.Data(1, 15028:45027)));

free_single_subj2_40hz = free_filtered ;
