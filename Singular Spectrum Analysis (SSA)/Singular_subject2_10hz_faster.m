...
load('Test_1mA_10Hz_ERP_SUBJ2.mat')    
RAW_SUBJECT_DATA = EEG.Data(1,:);

subject2_tacs_t1 = 15024;
subject2_tacs_t2 = subject2_tacs_t1 + 29999 ;


X_init = RAW_SUBJECT_DATA(1,subject2_tacs_t1: subject2_tacs_t2);  %FOR ORIGINAL TEST 
...
SHAM_ORIGINAL_BEST=filtfilt(b,a,filtfilt(d,c,EEG.Data(1, 15016:45015)));



free_single_subj2_10hz = free_filtered ;
...
R = corrcoef(SHAM_ORIGINAL_BEST(1, 5000:27000), free_filtered(1, 5000:27000));
